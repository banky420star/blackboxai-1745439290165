...
class DDQNModel:
    ...
    def train(self, states: np.ndarray, targets: np.ndarray, epochs: int = 1, verbose: int = 0):
        """Train the model"""
        return self.model.fit(states, targets, epochs=epochs, verbose=verbose, batch_size=32)
